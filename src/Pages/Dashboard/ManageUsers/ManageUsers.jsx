...
const ManageUsers = () => {
  ...
  const handleMakeAdmin = (user) => {
    fetch(`https://assignment-12-server-silk-seven.vercel.app/users/admin/${user._id}`, {
      method: "PATCH",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleMakeInstructor = (user) => {
    fetch(`https://assignment-12-server-silk-seven.vercel.app/users/instructor/${user._id}`, {
      method: "PATCH",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="overflow-x-auto w-3/10 mx-5 md:mx-28">
        <table className="table text-md w-full">
          {/* head */}
          <thead>
            <tr>
              <th>#</th>
                ...
                <td>
                  {user.role === "admin" ? (
                    ...
                    <button
                      ...
                      className="btn btn-ghost bg-indigo-500  text-white"
                    >
